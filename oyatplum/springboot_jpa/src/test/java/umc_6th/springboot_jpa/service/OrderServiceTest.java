...
import umc_6th.springboot_jpa.domain.Address;
...
import umc_6th.springboot_jpa.domain.item.Book;
import umc_6th.springboot_jpa.domain.item.Item;
import umc_6th.springboot_jpa.exception.NotEnoughStockException;
...
class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Assert.assertEquals("주문한 상품 종류 수 정확해야 한다.", 1, getOrder.getOrderItems().size());
        Assert.assertEquals("주문 가격은 수량 * 가격이다.", 10000 * orderCount, getOrder.getTotalPrice());
    ...
    public void 주문취소() throws Exception {
        ...
        Assert.assertEquals("주문 상태 취소시 상태는 CANCEL이다.", OrderStatus.CANCEL, getOrder.getStatus());
